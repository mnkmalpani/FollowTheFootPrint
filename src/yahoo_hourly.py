...
for stock in nifty100_list:
    ...
    current_price: DataFrame = yf.download(stock, start="2023-04-02", end=current_date,
...
df[df['follow_through_with_base'] == 'Y'].to_csv('potential_stocks_ind.csv', encoding='utf-8', index=False)